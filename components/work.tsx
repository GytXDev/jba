...
export default function Work() {
  ...
  const projects = [
    {
      title: "Siège de HPO & Associés",
      subtitle: "Owendo, Gabon",
      image: "/works/jba_hpo.webp",
      year: "2024",
    },
    {
      title: "BCEG Banque pour le Commerce et l'Entrepreneuriat",
      subtitle: "Libreville, Gabon",
      image: "/works/jba_bceg.webp",
      year: "2024",
    },
  ];
  ...
  return (
    <section
      id="work"
      className="py-24 relative overflow-hidden bg-gradient-to-b from-black to-neutral-900"
    >
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4 md:mb-0 text-white">
              Réalisations
              <br />
              <span className="text-white/70">Architecturales</span>
            </h2>
