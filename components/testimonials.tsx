...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      quote:
        "JBA a su comprendre notre vision et transformer notre siège social en un espace moderne, fonctionnel et esthétiquement remarquable. Leur professionnalisme est exemplaire.",
      author: "HPO & Associés",
      role: "Siège de Owendo, Gabon",
    },
    {
      quote:
        "Le travail de JBA pour la BCEG Banque a dépassé nos attentes. Chaque détail a été étudié avec soin, et le résultat reflète parfaitement notre image et nos valeurs.",
      author: "BCEG Banque",
      role: "Banque pour le Commerce et l’Entrepreneuriat, Gabon",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white">
            Ce que nos
            <br />
            <span className="text-white/70">clients disent de JBA</span>
          </h2>
        </motion.div>
